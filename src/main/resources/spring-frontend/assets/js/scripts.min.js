                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                getData('/books/author/more/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'tag':
                                getData('/books/tag/' + $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
            ...
            return {
                init: function () {
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/bookReview?bookid=' + $this.data('bookid') + '&text=' + $this.find('.Comments-review').val(), {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/rateBookReview?reviewid=' + $this.data('likeid') +'&value=' +  data.value , data, function (result) {
                            if (result.result) {
        ...
        var ProductCard = function () {
            ...
            return {
                init: function () {
                    ...
                    //&& $this.data('check')
                        if ($this.data('sendstatus') === 'ARCHIVED' ) {
                            Login().postData('/changeBookStatus/arch/'+ $this.data('bookid'), {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/rateBook?bookId='+ $this.closest('.Rating').data('bookid') + '&value=' + (check ? $this.val() : 0), {
            ...
            return {
                init: function () {
                    $('form.Topup').on('submit', function (e) {
                        var $this = $(this);
                        e.preventDefault();
                        Login().postData('/payment/?sum='+ $this.find('[name="sum"]').val() +'&user=' + $this.attr('data-sendHash'), {
